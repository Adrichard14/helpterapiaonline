<?php
    ...
    if($alt) {
        $elem = News::load($_GET['ID'], '0,1', NULL, 2.0);
        if(empty($elem)) {
	...
	$nav = ($alt ? 'alt' : 'add')."-news";
	$page_title = WRITER_OF.'notícias';
	$page_desc = NULL;
?>
<!DOCTYPE html>
				...
				<div class="container">
                    ...
                    <form id="wform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="slim slim-slide" data-service="responses/slim.php" data-ratio="<?php echo Format::ratio(News::$DESKTOP[0], News::$DESKTOP[1]); ?>" data-min-size="<?php echo implode(",", News::$DESKTOP); ?>">
