<?php
    ...
    if($alt) {
        $elem = Cirurgy::load($_GET['ID'], '0,1', NULL, 2.0);
        if(empty($elem)) {
            Display::Message("err","Cirurgia não encontrada");
            header("location: cirurgies.php");
            exit();
        }
        $elem = $elem[0];
	...
	$nav = ($alt ? 'alt' : 'add')."-cirurgy";
	$page_title = WRITER_OF.'cirurgias';
	$page_desc = NULL;
?>
<!DOCTYPE html>
				...
				<div class="container">
                    ...
                    <form id="wform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="slim slim-slide" data-service="responses/slim.php" data-ratio="<?php echo Format::ratio(Cirurgy::$DESKTOP[0], Cirurgy::$DESKTOP[1]); ?>" data-min-size="<?php echo implode(",", Cirurgy::$DESKTOP); ?>">
