...
if ($alt) {
    $elem = Plans::load($_GET['ID'], '0,1', NULL, 2.0);
    if (empty($elem)) {
            ...
            <div class="container">
                ...
                <form id="wform" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="slim slim-slide" data-service="responses/slim.php" data-ratio="<?php echo Format::ratio(Plans::$DESKTOP[0], Plans::$DESKTOP[1]); ?>" data-min-size="<?php echo implode(",", Plans::$DESKTOP); ?>">
                    ...
                    <div class="form-group">
                        <label>Preço</label>
                        <input type="text" name="price" class="form-control" value="<?php echo $elem['price']; ?>" />
                    </div>
                    <div class="form-group">
