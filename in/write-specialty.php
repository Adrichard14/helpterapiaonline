<?php
    ...
    if($alt) {
        $elem = Specialty::load($_GET['ID'], '0,1', NULL, 2.0);
        if(empty($elem)) {
            Display::Message("err", "Especialidade não encontrada");
	...
	$nav = ($alt ? 'alt' : 'add')."-specialty";
	$page_title = WRITER_OF.'Especialidades';
	$page_desc = NULL;
?>
<!DOCTYPE html>
...
<html lang="pt-br" class="no-js">
	...
	<body><?php include_once("inc/header.php"); ?>
        ...
        <?php
            ...
            Page::script(array(
                "assets/js/in/write-specialty.js"
            ));
        ?>
	</body>
	<!-- end: BODY -->
