<?php
    ...
    if($alt) {
        $elem = Slide::load($_GET['ID'], '0,1', NULL, 2.0);
        if(empty($elem)) {
	...
	$nav = ($alt ? 'alt' : 'add')."-slides";
	$page_title = WRITER_OF.SLIDES;
	$page_desc = NULL;
?>
<!DOCTYPE html>
				...
				<div class="container">
                    ...
                    <form id="wform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="slim slim-slide" data-service="responses/slim.php" data-ratio="<?php echo Format::ratio(Slide::$DESKTOP[0], Slide::$DESKTOP[1]); ?>" data-min-size="<?php echo implode(",", Slide::$DESKTOP); ?>">
