...
while (!$ready) {
    ...
    $list = Faq::load(-1, $page_limit, "`order` ASC", 2.0);
    $ready = !empty($list) || $page == 1;
    if (!$ready) $page--;
}
$paginator = new Paginator(Faq::paginator(2.0), "faqs.php?page=", $page, $limit);
$headers = array(
...
if (empty($list))
    ...
    $menu = array(
        'write-faq.php?ID=' . $i["ID"] => '<i class="clip-pencil-3"></i> ' . UPDATE,
    );
...
$nav = "list-faqs";
$page_title = LIST_OF . "Perguntas e respostas (Trabalhe conosco)" . ' <a href="write-faq.php"><i class="clip-plus-circle-2 text-success clickable" title="' . INSERT . '"></i></a>';
$page_desc = NULL;
?>
<!DOCTYPE html>
...
<body><?php include_once("inc/header.php"); ?>
    ...
    <!-- end: MAIN CONTAINER --><?php include_once("inc/footer.php");
                                Page::script("assets/js/in/faqs.js"); ?>
</body>
<!-- end: BODY -->
