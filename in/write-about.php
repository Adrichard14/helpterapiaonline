<?php
    ...
    if($alt) {
        $elem = About::load($_GET['ID'], '0,1', NULL, 2.0);
        if(empty($elem)) {
	...
	$nav = ($alt ? 'alt' : 'add')."-about";
	$page_title = WRITER_OF.'página institucional';
	$page_desc = NULL;
?>
<!DOCTYPE html>
				...
				<div class="container">
                    ...
                    <form id="wform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="title" class="form-control" value="soidisgrigjojerogkreogpko" />
                        </div>
                        <div class="form-group">
