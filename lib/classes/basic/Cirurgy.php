<?php
    class Cirurgy {
        ...
        public static $DATABASE         = "basic_cirurgy";
        public static $FOLDER           = "uploads/cirurgias";
        ...
        public static function create($FAKE_POST = NULL) {
            ...
            if($insert)
                return "Cirurgia cadastrada com sucesso!";
            exit("Erro ao cadastrar cirurgia, por favor tente novamente.");
        }
        public static function update($FAKE_POST = NULL) {
            ...
            if($update) {
                ...
                return "Cirurgia alterada com sucesso!";
            }
            exit("Erro ao atualizar cirurgia, por favor tente novamente.");
        }
        ...
        public static function status($ID, $status = 2) {
            ...
            if($status == 2) {
                if($update) {
                    self::reorder();
                    return "Cirurgia apagado com sucesso!";
                }
                exit("Erro ao apagar cirurgia, por favor tente novamente.");
            }
            return $update;
        }
