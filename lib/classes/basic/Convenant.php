<?php
    class Convenant {
        ...
        public static $DATABASE         = "basic_convenant";
        public static $FOLDER           = "uploads/convênios";
        ...
        public static function create($FAKE_POST = NULL) {
            ...
            exit("Erro ao cadastrar convênio, por favor tente novamente.");
        }
        public static function update($FAKE_POST = NULL) {
            ...
            if($update) {
                ...
                return "Convênio alterado com sucesso!";
            }
            exit("Erro ao atualizar convênio, por favor tente novamente.");
        }
        ...
        public static function status($ID, $status = 2) {
            ...
            if($status == 2) {
                if($update) {
                    self::reorder();
                    return "Convênio apagado com sucesso!";
                }
                exit("Erro ao apagar convênio, por favor tente novamente.");
            }
            return $update;
        }
