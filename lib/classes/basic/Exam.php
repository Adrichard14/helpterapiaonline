<?php
    class Exam {
        ...
        public static $DATABASE         = "basic_exam";
        public static $FOLDER           = "uploads/exames";
        ...
        public static function create($FAKE_POST = NULL) {
            ...
            exit("Erro ao cadastrar exame, por favor tente novamente.");
        }
        public static function update($FAKE_POST = NULL) {
            ...
            exit("Erro ao atualizar exame, por favor tente novamente.");
        }
        ...
        public static function status($ID, $status = 2) {
            ...
            if($status == 2) {
                if($update) {
                    self::reorder();
                    return "Exame apagado com sucesso!";
                }
                exit("Erro ao apagar exame, por favor tente novamente.");
            }
            return $update;
        }
