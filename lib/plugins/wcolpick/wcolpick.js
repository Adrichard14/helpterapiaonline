...
(function ($) {
	...
	$.fn.extend({
		colpick: wcolpick.init,
		colpickShow: wcolpick.showColpick,
		colpickHide: wcolpick.hideColpick,
		colpickDestroy: wcolpick.destroyColpick,
		colpickSetColor: wcolpick.setColpickColor,
		colpickGetColor: wcolpick.getColpickColor
	});
	$.extend({
		wcolpick:{
			hexToRgba: hexToRgba,
