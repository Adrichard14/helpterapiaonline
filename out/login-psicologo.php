<?php
session_start();
if (isset($_SESSION['l@#$@e@#r'])) {
    session_destroy();
};
// exit(var_dump($_SESSION['l@#$@e@#r2']));
                            ...
                            <div class="login-page bg-white shadow rounded p-4">
                                ...
                                <form class="login-form" method="post" data-id="experimente_gratis_login" id="form_login" data-name="">
                                    <div class="row">
                                        ...
                                        <div class=" col-lg-12">
                                            <p class="float-right forgot-pass"><a href="<?php echo PUBLIC_URL?>recuperar-senha-psicologo" class="text-dark font-weight-bold">Esqueceu a senha?</a></p>
                                        </div>
                                        <div class="col-lg-12 mb-0">
                                            <button type="submit" class="btn btn-primary w-100 defaultBtnColor">Entrar</button>
                                        </div>
                                        <div class="col-12 text-center">
                                            <p class="mb-0 mt-3"><small class="text-dark mr-2">Não tem uma conta?</small> <a href="<?php echo PUBLIC_URL ?>curriculo-psicologo" class="text-dark font-weight-bold">Cadastre-se</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
