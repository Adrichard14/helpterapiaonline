...
<body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="login-page bg-white shadow rounded p-4">
                                ...
                                <form class="login-form" method="post" id="form_pw">
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group position-relative">
                                                <label>Token para mudança de senha enviado no e-mail<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Digite aqui o seu token" name="recovery_token" required="">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group position-relative">
                                                <label>Nova senha <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Nova senha" name="password" required="">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group position-relative">
                                                <label>Repetição da nova senha <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" placeholder="Digite novamente a nova senha" name="password2" required="">
                                            </div>
                                        </div>
    ...
    Page::script(array(
        ...
        'out/js/nova-senha-psicologo.js'
    )); ?>
</body>
