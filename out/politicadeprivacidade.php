<?php session_start();
$page = StaticPost::load(10, null, null, -1, null);
$page1 = StaticPost::load(9, null, null, -1, null);
$page = $page[0];
$page1 = $page1[0];
// exit(var_dump($page)); 
?>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="section-title text-center normal">
                        <h2 class="normal text-white  mb-4"><strong>POLÍTICA DE PRIVACIDADE </strong></h2>
                    </div>
                </div>
            </div>
        </div>
